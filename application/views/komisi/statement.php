               ...
               <div class="col">
                    <div class="card">
                                   ...
                                   <div class="col-md-10">
                                        <div class="row input-daterange datepicker align-items-center">
                                             <div class="col col-md-4 col-lg-3">
                                                  <div class="input-group">
                                                       <input type="text" class="form-control text-center" readonly
                                                            name="search_startdate" data-date-format="yyyy-mm-dd"
                                                            placeholder="From" value="2023-05-01" />
                                                       <span class="input-group-btn">
                                                            <button type="button" class="btn btn-neutral shadow-lg"
                                                                 style="color:green"><i
                                             ...
                                             <div class="col col-md-4 col-lg-3">
                                                  <div class="input-group">
                                                       <input type="text" class="form-control text-center" readonly
                                                            name="search_enddate" data-date-format="yyyy-mm-dd"
                                                            placeholder="To" value="2023-05-30" />
                                                       <span class="input-group-btn">
                                                            <button type="button" class="btn btn-neutral shadow-lg"
                                                                 style="color:green"><i
                                                                      class="fa-regular fa-calendar-days"></i></button>
                                             ...
                                             <div class="col-12 col-md-3 text-center">
                                                  <button
                                                       class="btn btn-sm btn-block btn-outline-success btn-tooltip filter-cancel btn-lg"
                                                       title="Set Periode">Set Periode</button>
                                             </div>
                                        </div>
                                   </div>
                              </div>
                         ...
                         <div class="table-container">
                              <table class="table align-items-center table-flush" id="list_table_total_commission"
                                   data-url="https://demo4.cic-webpro.com/commission/commissionlistdata">
                                   <thead class="bg-success">
                                        <tr role="row" class="heading" style="color:white !important;">
                                             <th scope="col" class="text-center text-" style="width: 10px">#</th>
                                             <th scope="col" class=" text-center text-light" style="width: 1000px">
                                                  Username</th>
                                             <th scope="col" class="text-center text-light" style="width: 1000px">Nama
                                             </th>
                                             <th scope="col" class=" text-center text-light" style="width: 1000px ">
                                                  Jumlah</th>
                                             <th scope="col" class=" text-center text-light" style="width: 1000px">
