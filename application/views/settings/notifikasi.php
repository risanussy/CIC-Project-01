          ...
          <div class="col">
               <div class="card">
                    ...
                    <div class="table-container">
                         <table class="table align-items-center table-flush" id="notification_list" data-url="https://demo4.cic-webpro.com/setting/notificationlistdata">
                         ...
                         <tbody class="list">
                              ...
                              <tr>                         
                                        ...
                                        <td>
                                             <div class="alert alert-success text-center" role="alert" style="width:50px !important; padding:2px !important">
                                                  Email
                                             </div>
                                        </td>
                                        <td>
                                        ...
                                        <td style="text-align: center;">
                                             <button class="btn btn-sm btn-outline-success btn-tooltip filter-cancel" title="Edit"><i class="fa-regular fa-pen-to-square"></i></button>
                                             <button class="btn btn-sm btn-outline-success btn-tooltip filter-cancel" title="View"><i class="fa-solid fa-eye"></i></button>
                                        </td>
                              ...
                              <tr>                         
                                        ...
                                        <td>
                                             <div class="alert alert-danger text-center" role="alert" style="width:100px !important; padding:2px !important">
                                                  Tidak Aktif
                                             </div>
                                        </td>
                                        <td style="text-align: center;">
     ...
     <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
          <div class="modal-content">
               ...
               <form action="https://demo4.cic-webpro.com/setting/updatenotification" role="form" method="post" class="form-horizontal" id="form_notif_edit">
