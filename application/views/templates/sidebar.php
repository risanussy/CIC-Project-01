...
?>
      ...
      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
           <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#komisi" aria-expanded="true"
                aria-controls="komisi">
                <i class="fas fa-fw fa-money-check text-success"></i>
                <span class="text-light text-success">Komisi</span>
           </a>
           <div id="komisi" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-dark py-2 collapse-inner rounded">
      ...
      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
           <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#flip" aria-expanded="true"
                aria-controls="flip">
                <i class="fas fa-fw fa-credit-card text-success"></i>
                <span class="text-light">Flip</span>
           </a>
           <div id="flip" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-dark py-2 collapse-inner rounded">
      ...
      <li class="nav-item">
           ...
           <div id="settings" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-dark py-2 collapse-inner rounded">
                     <a class="collapse-item text-light" href="<?= base_url('settings'); ?>">Umum</a>
                     <a class="collapse-item text-light" href="<?= base_url('settings/notifikasi'); ?>">Notifikasi</a>
                     <a class="collapse-item text-light" href="<?= base_url('settings/withdraw2'); ?>">Withdraw</a>
                </div>
           </div>
      </li>
