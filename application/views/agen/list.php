<a href="<?= base_url('agen') ?>" class="btn btn-sm btn-neutral mb-4 bg-dark text-success ml-5 mt-3"><i
          class="fa fa-plus mr-1 mt-3"></i> Tambah Agen Baru</a>
                         ...
                         <table class="table align-items-center table-flush" id="list_table">
                              <thead class="thead-primary"
                                   ...
                                   <tr role="row" class="heading">
                                        ...
                                        <th scope="col" class="text-center text-light" style="width: 1000px">Username
                                        </th>
                                        <th scope="col" class="text-center text-light" style="width: 1000px">Nama</th>
                                        <th scope="col" class="text-center text-light" style="width: 1000px">Sponsor
                                        </th>
                                        <th scope="col" class="text-center text-light" style="width: 630px">Peringkat
                                        </th>
                                        ...
                                        <th scope="col" class="text-center text-light" style="width: 1000px">Tanggal
                                             Daftar</th>
                                        <th scope="col" class="text-center text-light" style="width: 1000px">Terakhir
                                             Login</th>
                                   </tr>
                              </thead>
                              <tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td>
                                             ...
                                             <a href="#"
                                                  class="btn btn-sm btn-outline-warning btn-tooltip status-member"
                                                  data-original-title="Login">
                                                  <i class="fas fa-user profile-icon"></i>
                                             </a>
                                             <a href="#" class="btn btn-sm btn-outline-danger btn-tooltip status-member"
...
>>>>>>> 010bc451e42df225ff507febc411598bed87858f
</div>
<script>
...
function initializeStatusMembers() {
     ...
     statusMembers.forEach(function(statusMember) {
          ...
          tooltipElement.classList.add(
               'tooltip-bottom'); // Ganti ke 'tooltip-top' untuk tampilan di atas ikon
