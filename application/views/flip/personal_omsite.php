               ...
               <div class="col">
                    <div class="card">
                         ...
                         <div class="card-body">
                              <div class="nav-wrapper">
                                   <ul class="nav nav-pills nav-fill flex-column flex-sm-row" id="tabs-icons-text"
                                        role="tablist">
                                        <li class="nav-item">
                                             <a class="nav-link active" id="tabs-total_omzet-tab" data-toggle="tab"
                                                  href="#tabs-total_omzet" role="tab" aria-controls="tabs-total_omzet"
                                                  aria-selected="true"><i
                                                       class="fa-solid fa-chart-simple mr-2"></i>Total
                                                  Personal Sales Agent</a>
                                        </li>
                                        <li class="nav-item">
                                             <a class="nav-link" id="tabs-history_omzet-tab" data-toggle="tab"
                                                  href="#tabs-history_omzet" role="tab"
                                                  aria-controls="tabs-history_omzet" aria-selected="false"><i
                                                       class="fa-regular fa-bell mr-2"></i>Personal
                                                  Sales terbaru</a>
                                        </li>
                                   </ul>
                              </div>
                         ...
                         <div class="tab-content" id="bonusListContent">
                              <div class="tab-pane fade show active" id="tabs-total_omzet" role="tabpanel"
                                   aria-labelledby="tabs-total_omzet-tab">
                                   <div class="table-container">
                                        <table class="table align-items-center table-flush"
                                             id="list_personal_omzet_total">
                              ...
                              <div class="tab-pane fade" id="tabs-history_omzet" role="tabpanel"
                                   aria-labelledby="tabs-history_omzet-tab">
                                   <div class="table-container">
