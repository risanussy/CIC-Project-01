                         ...
                         <div class="card-body pt-0">
                              <div class="nav-wrapper">
                                   <ul class="nav nav-pills nav-fill flex-column flex-sm-row" id="tabs-icons-text"
                                        role="tablist">
                                        <li class="nav-item">
                                             <a class="nav-link active" id="tabs-total_point-tab" data-toggle="tab"
                                                  href="#tabs-total_point" role="tab" aria-controls="tabs-total_point"
                                                  aria-selected="true"><i
                                                       class="fa-solid fa-chart-simple mr-2"></i>Total
                                                  Poin Member</a>
                                        </li>
                                        <li class="nav-item">
                                             <a class="nav-link" id="tabs-history_point-tab" data-toggle="tab"
                                                  href="#tabs-history_point" role="tab"
                                                  aria-controls="tabs-history_point" aria-selected="false"><i
                                                       class="fa-regular fa-bell mr-2"></i>History Poin Member</a>
                                        </li>
                                   </ul>
                              </div>
                              <br>
                              ...
                              <div class="card shadow">
                                   <div class="card-body">
                                        <div class="tab-content" id="bonusListContent">
                                             <div class="tab-pane fade show active" id="tabs-total_point"
                                                  role="tabpanel" aria-labelledby="tabs-total_point-tab">
                                                  <div class="table-container">
                                                       <table class="table align-items-center table-flush"
                                                            id="list_table_total_point"
                                                            data-url="https://demo4.cic-webpro.com/member/totalpointlistdata">
                                             ...
                                             <div class="tab-pane fade" id="tabs-history_point" role="tabpanel"
                                                  aria-labelledby="tabs-history_point-tab">
                                                  <div class="table-container">
                                                       <table class="table align-items-center table-flush"
                                                            id="list_table_history_point"
                                                            data-url="https://demo4.cic-webpro.com/member/historypointlistdata">
                                                            <thead class="bg-success">
                                                                 <tr role="row" class="heading"
                                                                      style="color:white !important;">
                                                                      <th scope="col" style="width: 10px">#</th>
